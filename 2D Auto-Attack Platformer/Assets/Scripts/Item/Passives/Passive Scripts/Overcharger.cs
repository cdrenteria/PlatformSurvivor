...
public class Overcharger : PassiveBase, PassiveActionsInterface
{
    ...
    public void ApplyPassiveEffect()
    {
        for (int y = 0; y < playerWeaponSlots.Count; y++)
        {
            ...
            {
                currentWeaponSlot.GetChild(0).gameObject.GetComponent<WeaponActionsInterface>().IncreaseEffectiveArea();
            }
        }
